...
public class StatsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String s, String[] args) {
        ...
        p.sendMessage("§7Organisation §8× §e" + (Organisation.hasOrganisation(p) ? Organisation.getOrganisation(p).getName() + (Organisation.isLeader(p, true) ? " §8(§eLeader§8)" : " §8(§e" + Organisation.getRankName(p) + "§8)") : "Keine Organisation"));
