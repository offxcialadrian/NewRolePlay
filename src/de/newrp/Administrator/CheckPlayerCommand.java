...
public class CheckPlayerCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String s, String[] args) {
        ...
        if(tg == null && Script.getNRPID(args[0]) != 0) {
            ...
            p.sendMessage("§7Organisation §8× §e" + (Organisation.hasOrganisation(offtg) ? Organisation.getOrganisation(offtg).getName() : "Keine Organisation") + (Organisation.isLeader(offtg, true) ? " §8(§eLeader§8)" : ""));
        ...
        p.sendMessage("§7Organisation §8× §e" + (Organisation.hasOrganisation(tg) ? Organisation.getOrganisation(tg).getName() : "Keine Organisation") + (Organisation.isLeader(tg, true) ? " §8(§eLeader§8)" : ""));
        StringBuilder houses = new StringBuilder();
