...
public class Abteilung implements CommandExecutor, TabCompleter {
    ...
    public enum Abteilungen {
        ...
        ARBEITSAMT(2, GOVERNMENT, "Arbeitsamt"),
        FINANZAMT(3, GOVERNMENT, "Finanzamt"),
        JUSTIZMINISTERIUM(4, GOVERNMENT, "Justizministerium"),
        AUSSENMINISTERIUM(5, GOVERNMENT, "Außenministerium"),
        BAUMINISTERIUM(6, GOVERNMENT, "Bauministerium"),
        STAATSOBERHAUPT(7, GOVERNMENT, "Staatsoberhaupt"),
