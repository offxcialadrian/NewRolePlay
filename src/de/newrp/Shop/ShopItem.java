...
public enum ShopItem {
    ...
    SAMSUNG_HANDY(52, "§cGalaxy S21", new ItemStack(Material.IRON_INGOT), 1, 1, 1, 1, 1, false, false, false, new ShopType[] {ShopType.ELECTRONIC}),
    HUAWEI_HANDY(53, "§cP60", new ItemStack(Material.IRON_INGOT), 1, 1, 1, 1, 1, false, false, false, new ShopType[] {ShopType.ELECTRONIC}),
    GOOGLE_HANDY(54, "§cPixel 10", new ItemStack(Material.IRON_INGOT), 1, 1, 1, 1, 1, false, false, false, new ShopType[] {ShopType.ELECTRONIC}),
    APPLE_HANDY(55, "§ciPhone 15", new ItemStack(Material.IRON_INGOT), 1, 1, 1, 1, 1, false, false, false, new ShopType[] {ShopType.ELECTRONIC}),
