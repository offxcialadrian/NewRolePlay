...
public class Corpse {
    ...
    public static final Map<UUID, EntityPlayer> npcMap = new HashMap<>();
    ...
    public static void spawnNPC(Player player, Location loc) {
        try {
            ...
            npcMap.put(player.getUniqueId(), entityPlayer);
    ...
    public static void removeNPC(Player player) {
        try {
            EntityPlayer entityPlayer = npcMap.remove(player.getUniqueId());
