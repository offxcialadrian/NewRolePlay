...
public enum Activities {
    ...
    PFANDNAHME("Pfandnahme", 1.0F, Arrays.asList(0, 3, 4)),
    PLANTAGE("Plantage", 0.2F, Arrays.asList(0, 3)),
    DROGEN("Drogen", 0.01F, Arrays.asList(0)),
    GELD("Geld", 0.05F, Arrays.asList(0, 1, 2, 3, 4)),
    BANKRAUB("Bankraub", 1.0F, Arrays.asList(0, 3)),
    GANGWAR("Gangwar", 1.0F, Arrays.asList(0)),
    ...
    REPORTAGE("Reportage", 1.0F, Arrays.asList(2)),
