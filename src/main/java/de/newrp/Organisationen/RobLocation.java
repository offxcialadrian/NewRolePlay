...
public enum RobLocation {
    ...
    ARCADE("Arcade", new Location(Script.WORLD, 401, 67, 750), Organisation.CORLEONE, "Kasse"),
    ...
    BURGERSTAND("Burger-Stand", new Location(Script.WORLD, 663, 64, 637), Organisation.KARTELL, "Kasse"),
