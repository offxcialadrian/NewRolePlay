...
public enum RobLocation {
    ...
    BANK("Bank", new Location(Script.WORLD, 974, 83, 966), Organisation.TRIOLA, "Kasse"),
    GERICHT("Gerichtsgebäude", new Location(Script.WORLD, 777, 79, 966), Organisation.TRIOLA, "Kasse"),
    LABOR("Labor", new Location(Script.WORLD, 383, 75, 1307), Organisation.TRIOLA, "Lager"),
    GARAGE("Garage", new Location(Script.WORLD, 681, 64, 1234), Organisation.TRIOLA, "Lager"),
