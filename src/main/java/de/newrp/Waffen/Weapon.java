...
public enum Weapon {
    ...
    AK47(2, Script.setName(Material.DIAMOND_HORSE_ARMOR, "§7Peacekeeper"), "Peacekeeper", 1.9F, .300, 30, 6D, 2.1, 6, 500, 0, Munition.AMMO_7_62_39MM),
    ...
    DESERT_EAGLE(5, Script.setName(Material.GOLDEN_HOE, "§7Ivory"), "Ivory", .8F, .900, 12, 10D, 2.9, 5, 600, -0.3, Munition.AMMO_50AE),
