...
public class DangerLevel implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cs, Command cmd, String s, String[] args) {
        ...
        if(!Beruf.getBeruf(p).equals(Beruf.Berufe.BUNDESNACHRICHTENDIENST)) {
        ...
        Beruf.Berufe.BUNDESNACHRICHTENDIENST.sendMessage(Policecomputer.PREFIX + Script.getName(p) + " hat die Gefährlichkeitsstufe von " + Script.getName(tg) + " auf " + level + " gesetzt.");
