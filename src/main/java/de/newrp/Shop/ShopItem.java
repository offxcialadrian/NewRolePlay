...
public enum ShopItem {
    ...
    PISTOLE(10, "§7Glory", new ItemStack(Material.IRON_HORSE_ARMOR), 15, 1, 1, 2000, 12000, 15, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    ...
    AK47(12, "§7Peacekeeper", new ItemStack(Material.DIAMOND_HORSE_ARMOR), 20, 1, 1, 5000, 22000, 25, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    HEISSE_SCHOKOLADE(43, "§rHeiße Schokolade",new ItemBuilder(Material.FLOWER_POT).setName("§rHeiße Schokolade").build(), 3, 2, 25, 3, 1800, 1, true, true, false, new ShopType[] {ShopType.CAFE}),
    FILTERKAFFEE(44, "§rFilterkaffee", new ItemBuilder(Material.FLOWER_POT).setName("§rFilterkaffee").build(), 3, 2, 25, 3, 1800, 1, true, true, false, new ShopType[] {ShopType.CAFE}),
    LATTE_MACCHIATO(45, "§rLatte Macchiato", new ItemBuilder(Material.FLOWER_POT).setName("§rLatte Macchiato").build(), 3, 2, 25, 3, 1800, 1, true, true, false, new ShopType[] {ShopType.CAFE}),
    ESPRESSO(46, "§rEspresso", new ItemBuilder(Material.FLOWER_POT).setName("§rErpresso").build(), 3, 2, 25, 4, 2100, 1, true, true, false, new ShopType[] {ShopType.CAFE}),
    CRAPPUCHINO(47, "§rCrappuchino", new ItemBuilder(Material.FLOWER_POT).setName("§rCrappuchino").build(), 3, 2, 25, 3, 1800, 1, true, true, false, new ShopType[] {ShopType.CAFE}),
    ...
    BASEBALLSCHLAEGER(50, "§7Baseballschläger", Baseballschlaeger.getItem(), 1, 1, 1, 220, 4500, 9, false, true, false, new ShopType[] {ShopType.GUNSHOP}),
    ...
    AMMO_762MM(59, "§7.762mm Munition (" + Weapon.AK47.getName() + ")", new ItemBuilder(Material.ARROW).setAmount(Weapon.AK47.getMagazineSize()).build(), 1, 1, 1, 30, 3000, 14, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    KEVLAR(51, "§7Schutzweste", Script.kevlar(1), 1, 1, 1, 500, 14900, 13, false, true, false, new ShopType[] {ShopType.GUNSHOP}),
    ...
    CD_1(65, "§6Gold", new ItemStack(Material.MUSIC_DISC_11), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_2(66, "§6Green", new ItemStack(Material.MUSIC_DISC_13), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_3(67, "§6Blocks", new ItemStack(Material.MUSIC_DISC_BLOCKS), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_4(68, "§6Chirp", new ItemStack(Material.MUSIC_DISC_CHIRP), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_5(69, "§6Far", new ItemStack(Material.MUSIC_DISC_FAR), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_6(70, "§6Mall", new ItemStack(Material.MUSIC_DISC_MALL), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_7(71, "§6Mellohi", new ItemStack(Material.MUSIC_DISC_MELLOHI), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_8(72, "§6Stal", new ItemStack(Material.MUSIC_DISC_STAL), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_9(73, "§6Strad", new ItemStack(Material.MUSIC_DISC_STRAD),   1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_10(74, "§6Ward", new ItemStack(Material.MUSIC_DISC_WARD), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    CD_11(75, "§6Wait", new ItemStack(Material.MUSIC_DISC_WAIT), 1, 1, 1, 1, 1, 0, false, true, false, new ShopType[] {ShopType.MUSIC}),
    ...
    FALLSCHIRM(94, "§7Fallschirm", new ItemBuilder(Material.ELYTRA).setName("§7Fallschirm").build(), 5, 1, 1, 600, 4100, 5, false, true, false, new ShopType[] {ShopType.GUNSHOP}),
    KABELBINDER(95, "§7Kabelbinder", new ItemBuilder(Material.STRING).setName("§7Kabelbinder").build(), 3, 1, 1, 100, 1900, 8, false, true, false, new ShopType[] {ShopType.GUNSHOP, ShopType.SUPERMARKET}),
    ...
    SCHROT(97, "§7Schrot (" + Weapon.JAGDFLINTE.getName() + ")", new ItemBuilder(Material.ARROW).setAmount(Weapon.JAGDFLINTE.getMagazineSize()).build(), 2, 1, 1, 50, 4500, 4, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    DEAGLE(98, "§7Ivory", new ItemBuilder(Material.GOLDEN_HOE).setName("§7Ivory").build(), 15, 1, 1, 4000, 16600, 12, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    AMMO_50AE(99, "§7.50AE Munition (" + Weapon.DESERT_EAGLE.getName() + ")", new ItemBuilder(Material.ARROW).setAmount(Weapon.DESERT_EAGLE.getMagazineSize()).build(), 2, 1, 1, 25, 4500, 5, false, false, false, new ShopType[] {ShopType.GUNSHOP}),
    ANGELRUTE(100, "§7Angelrute", new ItemBuilder(Material.FISHING_ROD).setName("§7Angelrute").build(), 10, 1, 1, 25, 1590, 2, false, true, false, new ShopType[] {ShopType.ANGELSHOP}),
    ...
    MEHL(119, "§fMehl", new ItemBuilder(Material.WHITE_DYE).setName("§fMehl").build(), 2, 1, 20, 20, 2000, 1, false, true, false, new ShopType[] {ShopType.SUPERMARKET}),
    ...
    SHISHA_1(121, "§6Shisha " + ShishaType.DOPPELAPFEL, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.DOPPELAPFEL.getName(), "§c" + ShishaType.DOPPELAPFEL.getName(), "§7" + ShishaType.DOPPELAPFEL.getDuration() + "/" + ShishaType.DOPPELAPFEL.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SHISHA_2(122, "§6Shisha " + ShishaType.PFIRSICH_MINZE, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.PFIRSICH_MINZE.getName(), "§c" + ShishaType.PFIRSICH_MINZE.getName(), "§7" + ShishaType.PFIRSICH_MINZE.getDuration() + "/" + ShishaType.PFIRSICH_MINZE.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SHISHA_3(123, "§6Shisha " + ShishaType.WASSERMELONE, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.WASSERMELONE.getName(), "§c" + ShishaType.WASSERMELONE.getName(), "§7" + ShishaType.WASSERMELONE.getDuration() + "/" + ShishaType.WASSERMELONE.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SHISHA_4(124, "§6Shisha " + ShishaType.ZITRONE, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.ZITRONE.getName(), "§c" + ShishaType.ZITRONE.getName(), "§7" + ShishaType.ZITRONE.getDuration() + "/" + ShishaType.ZITRONE.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SHISHA_5(125, "§6Shisha " + ShishaType.SPECIAL, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.SPECIAL.getName(), "§c" + ShishaType.SPECIAL.getName(), "§7" + ShishaType.SPECIAL.getDuration() + "/" + ShishaType.SPECIAL.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SHISHA_6(126, "§6Shisha " + ShishaType.TRAUBE, Script.setNameAndLore(Material.STICK, "§6Shisha " + ShishaType.TRAUBE.getName(), "§c" + ShishaType.TRAUBE.getName(), "§7" + ShishaType.TRAUBE.getDuration() + "/" + ShishaType.TRAUBE.getDuration()), 1, 1, 1, 10, 500, 0, false, true, false, new ShopType[] {ShopType.SHISHA}),
    SCHWERE_KEVLAR(127, "§7Schwere Schutzweste", Script.kevlar(2), 1, 1, 1, 1000, 14900, 16, false, true, false, new ShopType[] {ShopType.GUNSHOP}),
    OPPEL(128,CarType.OPPEL.getName(), Script.setName(new ItemStack(CarType.OPPEL.getMaterial(), 1), "§e" + CarType.OPPEL.getName()), 1, 1, 1, 7000, 10000, 10, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    VOLTSWAGEN(129, CarType.VOLTSWAGEN.getName(), Script.setName(new ItemStack(CarType.VOLTSWAGEN.getMaterial(), 1), "§e" + CarType.VOLTSWAGEN.getName()), 1, 1, 1, 12000, 8000, 14, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    NMW(130, CarType.NMW.getName(), Script.setName(new ItemStack(CarType.NMW.getMaterial(), 1), "§e" + CarType.NMW.getName()), 1, 1, 1, 17000, 14000, 18, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    AWDI(131, CarType.AWDI.getName(), Script.setName(new ItemStack(CarType.AWDI.getMaterial(), 1), "§e" + CarType.AWDI.getName()), 1, 1, 1, 25000, 20000, 22, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    MERCADAS(132, CarType.MERCADAS.getName(), Script.setName(new ItemStack(CarType.MERCADAS.getMaterial(), 1), "§e" + CarType.MERCADAS.getName()), 1, 1, 1, 40000, 40000, 26, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    PAWSCHE(133, CarType.PAWSCHE.getName(), Script.setName(new ItemStack(CarType.PAWSCHE.getMaterial(), 1), "§e" + CarType.PAWSCHE.getName()), 1, 1, 1, 60000, 70000, 30, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    ...
    MESSER(138, "§7Messer", Messer.getItem(), 1, 1, 1, 150, 4000, 10, false, true, false, new ShopType[] {ShopType.GUNSHOP}),
    ...
    WHALE(147, "§dWal", createItem(1755, "§dWal"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    SHARK(148, "§dHai", createItem(51444, "§dHai"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    SHEEP(149, "§dSchaf", createItem(62925, "§dSchaf"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    BEE(150, "§dBiene", createItem(31264, "§dBiene"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    FROG(151, "§dFrosch", createItem(51343, "§dFrosch"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    DINO(152, "§dDino", createItem(57302, "§dDino"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    ELEPHANT(153, "§dElefant", createItem(31297, "§dElefant"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    FISH(154, "§dFisch", createItem(22794, "§dFisch"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    PARROT(155, "§dPapagei", createItem(349, "§dPapagei"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
    PIG(156, "§dSchwein", createItem(14201, "§dSchwein"), 1, 1, 1, 50, 1000, 0, false, true, false, new ShopType[] {ShopType.MERCH}),
