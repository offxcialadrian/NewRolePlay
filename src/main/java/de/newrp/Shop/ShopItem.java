...
public enum ShopItem {
    ...
    OPPEL(128,CarType.OPPEL.getName(), Script.setName(new ItemStack(CarType.OPPEL.getMaterial(), 1), "§e" + CarType.OPPEL.getName()), 1, 1, 1, 5000, 10000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    VOLTSWAGEN(129, CarType.VOLTSWAGEN.getName(), Script.setName(new ItemStack(CarType.VOLTSWAGEN.getMaterial(), 1), "§e" + CarType.VOLTSWAGEN.getName()), 1, 1, 1, 5000, 8000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    NMW(130, CarType.NMW.getName(), Script.setName(new ItemStack(CarType.NMW.getMaterial(), 1), "§e" + CarType.NMW.getName()), 1, 1, 1, 12500, 14000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    AWDI(131, CarType.AWDI.getName(), Script.setName(new ItemStack(CarType.AWDI.getMaterial(), 1), "§e" + CarType.AWDI.getName()), 1, 1, 1, 17000, 20000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    MERCADAS(132, CarType.MERCADAS.getName(), Script.setName(new ItemStack(CarType.MERCADAS.getMaterial(), 1), "§e" + CarType.MERCADAS.getName()), 1, 1, 1, 31000, 40000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    PORSCHUH(133, CarType.PORSCHUH.getName(), Script.setName(new ItemStack(CarType.PORSCHUH.getMaterial(), 1), "§e" + CarType.PORSCHUH.getName()), 1, 1, 1, 87000, 70000, false, false, false, new ShopType[] {ShopType.CARDEALER}),
