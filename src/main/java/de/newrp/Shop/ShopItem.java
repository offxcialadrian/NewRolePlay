...
public enum ShopItem {
    ...
    OPPEL(128,CarType.OPPEL.getName(), Script.setName(new ItemStack(CarType.OPPEL.getMaterial(), 1), "§e" + CarType.OPPEL.getName()), 1, 1, 1, 6000, 10000, 10, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    VOLTSWAGEN(129, CarType.VOLTSWAGEN.getName(), Script.setName(new ItemStack(CarType.VOLTSWAGEN.getMaterial(), 1), "§e" + CarType.VOLTSWAGEN.getName()), 1, 1, 1, 10000, 8000, 14, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    NMW(130, CarType.NMW.getName(), Script.setName(new ItemStack(CarType.NMW.getMaterial(), 1), "§e" + CarType.NMW.getName()), 1, 1, 1, 16000, 14000, 18, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    AWDI(131, CarType.AWDI.getName(), Script.setName(new ItemStack(CarType.AWDI.getMaterial(), 1), "§e" + CarType.AWDI.getName()), 1, 1, 1, 24000, 20000, 22, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    MERCADAS(132, CarType.MERCADAS.getName(), Script.setName(new ItemStack(CarType.MERCADAS.getMaterial(), 1), "§e" + CarType.MERCADAS.getName()), 1, 1, 1, 35000, 30000, 26, false, false, false, new ShopType[] {ShopType.CARDEALER}),
    PAWSCHE(133, CarType.PAWSCHE.getName(), Script.setName(new ItemStack(CarType.PAWSCHE.getMaterial(), 1), "§e" + CarType.PAWSCHE.getName()), 1, 1, 1, 45000, 40000, 30, false, false, false, new ShopType[] {ShopType.CARDEALER}),
