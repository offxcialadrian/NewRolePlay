...
public enum ShopItem {
    ...
    PET_DOG(160, "Hund", Script.setName(new ItemStack(Material.WOLF_SPAWN_EGG), "§aHund"), 1, 1, 1, 7000, 10000, 5, false, false, false, new ShopType[] {ShopType.PETS}),
    PET_CAT(161, "Katze", Script.setName(new ItemStack(Material.CAT_SPAWN_EGG), "§aKatze"), 1, 1, 1, 10000, 12000, 5, false, false, false, new ShopType[] {ShopType.PETS}),
    PET_PARROT(162, "Papagei", Script.setName(new ItemStack(Material.PARROT_SPAWN_EGG), "§aPapagei"), 1, 1, 1, 20000, 15000, 5, false, false, false, new ShopType[] {ShopType.PETS}),
    PET_FOX(163, "Fuchs", Script.setName(new ItemStack(Material.FOX_SPAWN_EGG), "§aFuchs"), 1, 1, 1, 30000, 20000, 5, false, false, false, new ShopType[] {ShopType.PETS});
