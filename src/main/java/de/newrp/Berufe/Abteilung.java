...
public class Abteilung implements CommandExecutor, TabCompleter {
    ...
    public enum Abteilungen {
        ...
        FINANZAMT(3, GOVERNMENT, "Finanzamt", false, "Finanzminister"),
        ...
        FINANZMINISTER(7, GOVERNMENT, "Finanzministerium", true, "Finanzminister"),
        JUSTIZMINISTER(8, GOVERNMENT, "Gerichtshof", true, "Justizminister"),
