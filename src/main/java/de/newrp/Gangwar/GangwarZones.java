...
public enum GangwarZones {
    ...
    ZOO(4, "Zoo", new Location[] { new Location(Script.WORLD, 101, 66, 721, 213.37256f, 2.2247376f), new Location(Script.WORLD, 61, 67, 770, 232.57605f, -2.4252532f), new Location(Script.WORLD, 92, 66, 647, 247.27612f, -2.4252245f), new Location(Script.WORLD, 23, 66, 616, 303.53223f, -0.6252243f)}, new Location(Script.WORLD, -7.3, 50, 775.2, -145.1f, 18.6f), new Location(Script.WORLD, 86.4, 100, 625.4, -273.4f, 90f),
