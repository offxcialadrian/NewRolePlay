...
public enum GangwarZones {
    ...
    FUNPARK(3, "Freizeitpark", new Location[] { new Location(Script.WORLD, 786, 63, 801, 213.37256f, 2.2247376f), new Location(Script.WORLD, 754, 64, 779, 232.57605f, -2.4252532f), new Location(Script.WORLD, 744, 65, 738, 247.27612f, -2.4252245f), new Location(Script.WORLD, 738, 65, 700, 303.53223f, -0.6252243f), new Location(Script.WORLD, 747, 63, 672, 313.60486f, 6.7247787f)}, new Location(Script.WORLD, 797, 61, 657, 341.0631f, 4.7747774f), new Location(Script.WORLD, 878, 101, 770, 131.0664f, 24.124739f),
            new Location[] {new Location(Script.WORLD, 814, 67, 667, 1.4716797f, 12.274769f), new Location(Script.WORLD, 868, 66, 743, 284.67517f, 18.874771f), new Location(Script.WORLD, 813, 66, 748, 212.33923f, 42.65246f)}),
    ZOO(4, "Zoo", new Location[] { new Location(Script.WORLD, 101, 66, 721, 213.37256f, 2.2247376f), new Location(Script.WORLD, 61, 67, 770, 232.57605f, -2.4252532f), new Location(Script.WORLD, 92, 66, 647, 247.27612f, -2.4252245f), new Location(Script.WORLD, 23, 66, 616, 303.53223f, -0.6252243f)}, new Location(Script.WORLD, 78, 66, 636, 341.0631f, 4.7747774f), new Location(Script.WORLD, -5, 67, 764, 131.0664f, 24.124739f),
            new Location[] {new Location(Script.WORLD, 35, 66, 759, 1.4716797f, 12.274769f), new Location(Script.WORLD, 27, 66, 720, 284.67517f, 18.874771f), new Location(Script.WORLD, 69, 66, 681, 128.69434f, 3.424541f), new Location(Script.WORLD, 36, 65, 673, 128.69434f, 3.424541f), new Location(Script.WORLD, 56, 76, 690, 128.69434f, 3.424541f)});
