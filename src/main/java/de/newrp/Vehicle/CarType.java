...
public enum CarType {
    ...
    VOLTSWAGEN("Voltswagen", TreeSpecies.ACACIA, Material.ACACIA_BOAT, 700, 1.3, 50, Fuel.BENZIN, 1.8F, 14900, 200,1.3F, 5000,200),
    NMW("NMW", TreeSpecies.DARK_OAK, Material.DARK_OAK_BOAT, 900, 1.6, 40, Fuel.BENZIN, 1.6F, 27500, 282,1.6F, 10000, 300),
    AWDI("Awdi", TreeSpecies.BIRCH, Material.BIRCH_BOAT, 1100, 2.0, 150, Fuel.BENZIN, 1.4F, 52000, 242, 2.0F, 15000, 400),
    MERCADAS("Mercadas", TreeSpecies.REDWOOD, Material.SPRUCE_BOAT, 1300, 1.0, 55, Fuel.BENZIN, 1.2F, 23400, 235,1.0F, 20000, 500),
    PORSCHUH("Porschuh", TreeSpecies.GENERIC, Material.OAK_BOAT, 1500, 1.0, 0, Fuel.BENZIN, 1.0F, 0, 0, 1.0F, 0, 600);
